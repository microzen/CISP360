...
int main(int argc, char const *argv[])
{
    ...
    do
    {
        ...
        int monkeyIndexCircle = ((MONKEY_SIZE * WEEK_SIZE) - (end - loop) - 1) % MONKEY_SIZE;
...
void outputInfo(int monkeysFood[WEEK_SIZE][MONKEY_SIZE])
{
    ...
    cout << "\nThe least amount of food eaten during the week by any one monkey is:" << least;
    cout << "\nThe greatest amount of food eaten during the week by any one monkey is:" << greatest
         << endl;
}
